...
using PracticeModelValidation.Models;

namespace PracticeModelValidation.Controllers
{
    public class MoviesController : Controller
    {
        private readonly PracticeModelValidationContext _context;

        public MoviesController(PracticeModelValidationContext context)
        {
            _context = context;
        }
